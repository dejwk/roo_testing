...
The profile exports the normal upstream identity macros, including
`CONFIG_IDF_TARGET_ESP32`, `CONFIG_IDF_TARGET`,
`CONFIG_IDF_TARGET_ARCH_XTENSA`, `ARDUINO_ARCH_ESP32`,
`ARDUINO_ESP32_DEV`, `ARDUINO_BOARD`, and `ARDUINO_VARIANT`. It also exports
...
1. its mutually exclusive ESP-IDF and Arduino identity macros;
2. matching ESP-IDF SoC header/include roots and Arduino variant pins;
