...
/* This function is not part of the newlib API, it is defined in
 * libc/stdio/local.h There is no nice way to get __cleanup member populated
 * while avoiding __sinit, so extern declaration is used here.
 */
