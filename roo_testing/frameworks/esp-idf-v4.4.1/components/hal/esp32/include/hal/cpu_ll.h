...
static inline uint64_t cpu_ll_ptr_to_pc(const void* addr)
{
    return ((uint64_t) addr);
}

static inline void* cpu_ll_pc_to_ptr(uint64_t pc)
{
    return (void*) ((pc & 0x3fffffffffffffffULL) | 0x4000000000000000ULL);
}
