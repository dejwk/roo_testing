...
class FakeIli9341Spi : public SimpleFakeSpiDevice {
 public:
  FakeIli9341Spi(roo_testing_transducers::Viewport& viewport,
                 const std::string& name = "display_ILI9341")
