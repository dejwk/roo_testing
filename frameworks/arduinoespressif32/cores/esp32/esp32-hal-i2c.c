...
#define DR_REG_I2C_EXT_BASE_FIXED               (&_i2c)
#define DR_REG_I2C1_EXT_BASE_FIXED              (&_i2c1)
...
static i2c_t _i2c_bus_array[2] = {
    {(volatile i2c_dev_t *)(DR_REG_I2C_EXT_BASE_FIXED), 0, -1, -1,I2C_NONE,I2C_NONE,I2C_ERROR_OK,NULL,0,0,0,0},
    {(volatile i2c_dev_t *)(DR_REG_I2C1_EXT_BASE_FIXED), 1, -1, -1,I2C_NONE,I2C_NONE,I2C_ERROR_OK,NULL,0,0,0,0}
...
i2c_err_t i2cWrite(i2c_t * i2c, uint16_t address, uint8_t* buff, uint16_t size, bool sendStop, uint16_t timeOutMillis){
    return i2cFakeWrite(i2c->num, address, buff, size, sendStop, timeOutMillis);
...
i2c_err_t i2cRead(i2c_t * i2c, uint16_t address, uint8_t* buff, uint16_t size, bool sendStop, uint16_t timeOutMillis, uint32_t *readCount){
    return i2cFakeRead(i2c->num, address, buff, size, sendStop, timeOutMillis);
